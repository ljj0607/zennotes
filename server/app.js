...
const defaultDbPath = path.resolve(__dirname, '../data/zennotes.db');
...
function createDatabase(dbPath, seed = true) {
...
export function createApp({dbPath = defaultDbPath, seed = true} = {}) {
  const app = express();
  const db = createDatabase(dbPath, seed);
